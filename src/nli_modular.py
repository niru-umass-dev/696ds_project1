...
class SummNLI():
  ...
  def __init__(self, data_path:str = 'data/combined_data.json', data_type: str = 'base', summ_type:str = 'ref', summ_sent: bool = False):
  ...
  def compute(self):
    ...
    if summ_to_sent == True:
        ...
        if summ_type == 'ref':
            ...
            for d in range(len(data)):
                ...
                # ref aggregations
                ref_sent_p1, ref_sent_p2, ref_sent1_ent, ref_sent2_ent, ref_count = summ_sent_cont_helper(data[d]['refs_a'][0],data[d]['refs_b'][0], data[d]['refs_comm'][0], ref_a_sum, ref_b_sum, ref_comm_sum, 'ref')
                ...
                cont_label, cont_prob = compute_NLI(ref_sent_p1, ref_sent_p2)
            ...
            for d in range(20,len(data)):
                ...
                # gen aggregations
                gen_sent_p1, gen_sent_p2, gen_sent1_ent, gen_sent2_ent, gen_count = summ_sent_cont_helper(data[d]['gen_a'],data[d]['gen_b'],data[d]['gen_comm'], gen_a_sum, gen_b_sum, gen_comm_sum, 'gen')
                ...
                cont_label, cont_prob = compute_NLI(gen_sent_p1, gen_sent_p2)
    ...
    if self.summ_sent == True:
        cont_df.to_csv(f'data/results/summ_sentpairs_nli_contrast_{self.summ_type}_{self.data_type}.csv', index = None, header=True)
    ...
    if summ_to_sent == True:
        ...
        if summ_type == 'ref':
            ...
            for d in range(len(data)):
                ...
                # ref aggregations
                ref_sent_p1, ref_sent_p2, ref_sent1_source, ref_sent1_source_ent,ref_sent2_ent, ref_count = source_sent_fact_helper(source_a, source_b, ref_a_sum, ref_b_sum, ref_comm_sum, 'ref')
            ...
            for d in range(20,len(data)):
                ...
                # gen aggregations
                gen_sent_p1, gen_sent_p2, gen_sent1_source, gen_sent1_source_ent, gen_sent2_ent, gen_count = source_sent_fact_helper(source_a, source_b, gen_a_sum, gen_b_sum, gen_comm_sum, 'gen')
    ...
    if self.summ_sent == True:
        ...
        fact_pop_df.to_csv(f'data/results/summ_sentpairs_nli_factuality_{self.summ_type}_{self.data_type}.csv', index = None, header=True)
        fact_pop_df.to_csv(f'data/results/summ_sentpairs_nli_popular_{self.summ_type}_{self.data_type}.csv', index = None, header=True) 
